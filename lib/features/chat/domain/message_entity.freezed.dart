...
class _$_MessageEntity with DiagnosticableTreeMixin implements _MessageEntity {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'MessageEntity(messageId: $messageId, senderId: $senderId, receiverId: $receiverId, content: $content, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, messageId, senderId, receiverId, content, createdAt);
